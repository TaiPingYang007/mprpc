...
class ResultCode :
 ...
 public:
  ...
  enum : int {
    kErrormasgFieldNumber = 2,
    kErrcodeFieldNumber = 1,
  };
  // bytes errormasg = 2;
  void clear_errormasg();
  const std::string& errormasg() const;
  void set_errormasg(const std::string& value);
  void set_errormasg(std::string&& value);
  void set_errormasg(const char* value);
  void set_errormasg(const void* value, size_t size);
  std::string* mutable_errormasg();
  std::string* release_errormasg();
  void set_allocated_errormasg(std::string* errormasg);
  private:
  const std::string& _internal_errormasg() const;
  void _internal_set_errormasg(const std::string& value);
  std::string* _internal_mutable_errormasg();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr errormasg_;
...
// bytes errormasg = 2;
inline void ResultCode::clear_errormasg() {
  errormasg_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ResultCode::errormasg() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errormasg)
  return _internal_errormasg();
}
inline void ResultCode::set_errormasg(const std::string& value) {
  _internal_set_errormasg(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errormasg)
}
inline std::string* ResultCode::mutable_errormasg() {
  // @@protoc_insertion_point(field_mutable:fixbug.ResultCode.errormasg)
  return _internal_mutable_errormasg();
}
inline const std::string& ResultCode::_internal_errormasg() const {
  return errormasg_.GetNoArena();
}
inline void ResultCode::_internal_set_errormasg(const std::string& value) {
  
  errormasg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ResultCode::set_errormasg(std::string&& value) {
  
  errormasg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.ResultCode.errormasg)
}
inline void ResultCode::set_errormasg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errormasg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.ResultCode.errormasg)
}
inline void ResultCode::set_errormasg(const void* value, size_t size) {
  
  errormasg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.ResultCode.errormasg)
}
inline std::string* ResultCode::_internal_mutable_errormasg() {
  
  return errormasg_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ResultCode::release_errormasg() {
  // @@protoc_insertion_point(field_release:fixbug.ResultCode.errormasg)
  
  return errormasg_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ResultCode::set_allocated_errormasg(std::string* errormasg) {
  if (errormasg != nullptr) {
    
  } else {
    
  }
  errormasg_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), errormasg);
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResultCode.errormasg)
}
