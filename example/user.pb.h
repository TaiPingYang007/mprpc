...
class ResultCode final :
 ...
 public:
  ...
  void set_errormasg(ArgT0&& arg0, ArgT... args);
  std::string* mutable_errormasg();
  PROTOBUF_NODISCARD std::string* release_errormasg();
  void set_allocated_errormasg(std::string* errormasg);
  private:
  const std::string& _internal_errormasg() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_errormasg(const std::string& value);
...
inline void ResultCode::clear_errormasg() {
  _impl_.errormasg_.ClearToEmpty();
}
...
void ResultCode::set_errormasg(ArgT0&& arg0, ArgT... args) {
 
 _impl_.errormasg_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errormasg)
}
inline std::string* ResultCode::mutable_errormasg() {
  std::string* _s = _internal_mutable_errormasg();
...
inline void ResultCode::set_allocated_errormasg(std::string* errormasg) {
  ...
  _impl_.errormasg_.SetAllocated(errormasg, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.errormasg_.IsDefault()) {
    _impl_.errormasg_.Set("", GetArenaForAllocation());
  }
