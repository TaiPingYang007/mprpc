...
PROTOBUF_CONSTEXPR ResultCode::ResultCode(
    ...
    /*decltype(_impl_.errormasg_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, _impl_.errormasg_),
  ~0u,  // no _has_bits_
...
uint8_t* ResultCode::_InternalSerialize(
  ...
  // bytes errormasg = 2;
  if (!this->_internal_errormasg().empty()) {
...
void ResultCode::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_errormasg().empty()) {
    _this->_internal_set_errormasg(from._internal_errormasg());
  }
...
void ResultCode::InternalSwap(ResultCode* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.errormasg_, lhs_arena,
      &other->_impl_.errormasg_, rhs_arena
  );
