...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, errormasg_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\nuser.proto\022\006fixbug\"0\n\nResultCode\022\017\n\007er"
  "rcode\030\001 \001(\005\022\021\n\terrormasg\030\002 \001(\014\")\n\014LoginR"
...
ResultCode::ResultCode(const ResultCode& from)
  ...
  errormasg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_errormasg().empty()) {
    errormasg_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.errormasg_);
  }
...
void ResultCode::SharedDtor() {
  errormasg_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_errormasg();
...
::PROTOBUF_NAMESPACE_ID::uint8* ResultCode::_InternalSerialize(
  ...
  // bytes errormasg = 2;
  if (this->errormasg().size() > 0) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_errormasg(), target);
  }
...
void ResultCode::InternalSwap(ResultCode* other) {
  ...
  errormasg_.Swap(&other->errormasg_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
